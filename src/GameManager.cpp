...
void GameManager::Draw() {
    ...
    switch (currentState) {
        ...
        case GameState::WAVE_SELECTION: {
            ...
            bool isValidSelection = (testConfig.stage == 1 && testConfig.wave <= 10) || (testConfig.stage == 2 && testConfig.wave <= 10) || (testConfig.stage == 3 && testConfig.wave <= 1) || (testConfig.stage == 4 && testConfig.wave <= 10) || (testConfig.stage == 7 && testConfig.wave == 1 && testConfig.batch == 1);
            if (!isValidSelection) {
