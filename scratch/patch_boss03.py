...
def generate_boss03_anim():
    print("Loading chicken08.png...")
    img = Image.open('assets/enemy/chicken08.png').convert('RGBA')
    ...
    for i in range(24):
        ...
        with warnings.catch_warnings():
            ...
            # Handle scikit-image version differences
