...
print(f"Calculated Pivots -> Left: {left_pivot:.1f}, Right: {right_pivot:.1f}, Leg Y: {leg_y_threshold:.1f}")
...
for f in range(frames):
    ...
    # Mạnh hơn rất nhiều để thấy rõ cánh vỗ
    ...
    if np.sum(w_alpha) > 0:
        ...
        # Thêm padding để ảnh không bị cắt sát mép
        pad = 10
