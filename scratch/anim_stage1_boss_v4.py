...
for f in range(frames):
    ...
    for i, (x, y) in enumerate(src_points):
        ...
        if y < head_y_threshold and min_x + actual_width * 0.4 < x < min_x + actual_width * 0.6:
            ...
            # Sway left/right, chu kỳ gấp đôi cho hiệu ứng lửa cháy nhanh hơn
            flame_cycle = math.sin(progress * math.pi * 4) 
            dst_points[i, 0] += flame_cycle * 20.0 * flame_factor * flame_factor
