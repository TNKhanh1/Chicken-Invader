...
- **Thứ tự Vẽ (Layering):** Tinh chỉnh Layer đồ họa: Đạn và tia Laser của người chơi sẽ được vẽ ở lớp dưới, đè lên trên là hình ảnh của Boss, tạo cảm giác đạn "găm" vào Boss có chiều sâu và chân thực hơn.
